...
/**
 * Interface CLI globale au projet SAT. Propose certaines méthodes
 * utilitaires utilisées par tous les sous-projets.
 */
public abstract class GlobalCLI extends CLI {
	 ...
	 * @param in		Le flux d'entrée du CLI
	 * @param out		Le flux de sortie du CLI
	 * @param prompt	Le prompt affiché au début de chaque ligne
	 */
