...
public class Tower implements RadioServerDelegate {
	...
	/**
	 * Retourne l'unique instance de la classe Tower. Si cette instance
	 * n'existe pas encore, elle est automatiquement créée.
	 * 
	...
	/**
	 * Le serveur-radio de la tour. Le serveur radio est chargé de toute
	 * la gestion technique de la communication avec le monde extérieur.
	 */
	 ...
	 * 
	 * @param engine		Le moteur de radio à ajouter.
	 * 
	 * @throws IOException	L'initilisation du moteur peut provoquer une
	 * 						<code>IOException</code> qui est passée au
	 * 						code appelant.
	 */
	 ...
	 * <code>./sat tower</code>.
	 * 
	 * @param args	Les paramètres de la ligne de commande. Ces paramètres ne
	 * 				sont pas utilisés.
	 */
